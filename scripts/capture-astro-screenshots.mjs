...
const shots = [
  ...
  { name: 'search-seo-desktop', url: '/search-seo/', width: 1440, height: 1200 },
  { name: 'search-seo-tablet', url: '/search-seo/', width: 768, height: 1200 },
  { name: 'advertising-desktop', url: '/advertising/', width: 1440, height: 1200 },
  { name: 'automation-mobile', url: '/ai-automation/', width: 390, height: 1200 },
  ...
  { name: 'results-desktop', url: '/results/', width: 1440, height: 1200 },
  { name: 'demo-mobile', url: '/demo/', width: 390, height: 1200 },
  { name: 'contact-mobile', url: '/contact/', width: 390, height: 1200 },
  { name: 'privacy-mobile', url: '/privacy-policy/', width: 390, height: 1200 },
