...
1. **Answer Block Quality** — Does the content contain explicit Q+A patterns?
2. **Self-Containment** — Can passages be extracted and understood alone?
3. **Statistical Density** — Are there specific numbers, percentages, timeframes?
4. **Structural Clarity** — Is the content organized for parsing, not just reading?
5. **Expertise Signals** — Are there author bylines, cited sources, publication dates?
6. **AI Query Alignment** — Does the content match how users phrase questions to AI?
...
*Local business AI visibility audits — [localbusinesssearch.com](https://localbusinesssearch.com)*
